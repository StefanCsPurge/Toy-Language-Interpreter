...
public class MainWindow implements Initializable{
    ...
    @FXML
    TableColumn<Map.Entry<Integer,Value>, Integer> latchTableKeyCol;
    @FXML
    TableColumn<Map.Entry<Integer,Value>, String> latchTableCountCol;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        latchTableKeyCol.setCellValueFactory(p-> new SimpleIntegerProperty(p.getValue().getKey()).asObject());
        latchTableCountCol.setCellValueFactory(p-> new SimpleStringProperty(p.getValue().getValue() + " "));
    ...
    private void setLatchTable() {
        latchTable.setItems(FXCollections.observableList(new ArrayList<>(myController.getRepository().getProgramList().get(0).getLatchTable().getContent().entrySet())));
        latchTable.refresh();
    }
