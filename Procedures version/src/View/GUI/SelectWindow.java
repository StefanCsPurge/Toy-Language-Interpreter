    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        runOptionButton.setOnAction(actionEvent -> {
            ...
            try {
                ...
                ProgramState realProgram = new ProgramState(new Model.ADT.Stack<>(), new Model.ADT.Stack<>(), new MyList<>(), new Model.ADT.Dictionary<>(), new Heap<>(),new ProcTable(), programTorRun);
