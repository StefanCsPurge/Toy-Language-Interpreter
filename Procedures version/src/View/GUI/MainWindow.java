...
public class MainWindow implements Initializable{
    ...
    @FXML
    TableView<Map.Entry<String, Pair<List<String>,Statement>>> procTable;
    @FXML
    TableColumn<Map.Entry<String, Pair<List<String>,Statement>>, String> procNameCol;
    @FXML
    TableColumn<Map.Entry<String, Pair<List<String>,Statement>>, String> procBodyCol;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        procNameCol.setCellValueFactory(p-> new SimpleStringProperty(p.getValue().getKey() + " "));
        procBodyCol.setCellValueFactory(p-> new SimpleStringProperty(p.getValue().getValue().getKey() + "  " + p.getValue().getValue().getValue()));
    ...
    private void setProcTable() {
        procTable.setItems(FXCollections.observableList(new ArrayList<>(myController.getRepository().getProgramList().get(0).getProcTable().getContent().entrySet())));
        procTable.refresh();
    }
