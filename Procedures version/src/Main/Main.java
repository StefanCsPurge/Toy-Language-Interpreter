...
import Model.statement.Procedure.CallStmt;
import Model.statement.Procedure.CreateProcedureStmt;
...
public class Main {
    public static void main(String[] args){
        ...
        console.addCommand(new RunExampleCommand("9","*procedures example*",examples.get(8)));
        console.addCommand(new RunExampleCommand("10","*sleep example*",examples.get(9)));
    ...
    public static List<Statement> getExamples() {
        ...
        Statement ex9 = assemble(
                new CreateProcedureStmt("sum",assemble(
                        new VarDeclStmt("v",new IntType()),new AssignStmt("v", new ArithmeticExpression('+', new VariableExpression("a"), new VariableExpression("b"))),
                        new PrintStmt(new VariableExpression("v"))),
                        "a","b"),
                new CreateProcedureStmt("product",assemble(
                        new VarDeclStmt("v",new IntType()),new AssignStmt("v", new ArithmeticExpression('*', new VariableExpression("a"), new VariableExpression("b"))),
                        new PrintStmt(new VariableExpression("v"))),
                        "a","b"),
                new VarDeclStmt("v", new IntType()), new VarDeclStmt("w", new IntType()),
                new AssignStmt("v", new ValueExpression(new IntValue(2))), new AssignStmt("w", new ValueExpression(new IntValue(5))),
                new CallStmt("sum",new ArithmeticExpression('*',new VariableExpression("v"),new ValueExpression(new IntValue(10))),new VariableExpression("w")),
                new PrintStmt(new VariableExpression("v")),
                new ForkStmt(assemble(
                        new CallStmt("product",new VariableExpression("v"),new VariableExpression("w")),
                        new ForkStmt(new CallStmt("sum",new VariableExpression("v"),new VariableExpression("w")))
                ))
        );
        ...
        Statement ex10 = assemble(
                new VarDeclStmt("v", new IntType()), new AssignStmt("v", new ValueExpression(new IntValue(10))),
                new ForkStmt(assemble(
                        new AssignStmt("v",new ArithmeticExpression('-',new VariableExpression("v"),new ValueExpression(new IntValue(1)))),
                        new AssignStmt("v",new ArithmeticExpression('-',new VariableExpression("v"),new ValueExpression(new IntValue(1)))),
                        new PrintStmt(new VariableExpression("v"))
                )),
                new SleepStmt(new ValueExpression(new IntValue(10))),
