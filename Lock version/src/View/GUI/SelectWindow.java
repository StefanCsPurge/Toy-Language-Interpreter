...
public class SelectWindow implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        optStr.add("*for example*");
        optStr.add("*Lock example*");
        ...
        runOptionButton.setOnAction(actionEvent -> {
            ...
            try {
                ...
                ProgramState realProgram = new ProgramState(new Model.ADT.Stack<>(), new Model.ADT.Dictionary<>(), new MyList<>(), new Model.ADT.Dictionary<>(), new Heap<>(), new LockTable(), programTorRun);
