...
public class ProgramState {
    ...
    public ProgramState(IStack<Statement> stack ,IDictionary<String,Value> syt,IList<Value> out,
                        IDictionary<String,BufferedReader> ft, IHeap<Value> h, ILockTable lt, Statement program) {
    ...
    public void setLockTable(ILockTable newLockTable) { lockTable = newLockTable; }
