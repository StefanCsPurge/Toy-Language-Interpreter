...
public class MainWindow implements Initializable{
    ...
    @FXML
    TableView<Map.Entry<Integer, Pair<Integer,List<Integer>>>> barrierTable;
    @FXML
    TableColumn<Map.Entry<Integer, Pair<Integer,List<Integer>>>,String> BarrierAddressCol;
    @FXML
    TableColumn<Map.Entry<Integer, Pair<Integer,List<Integer>>>,String> BarrierNCol;
    @FXML
    TableColumn<Map.Entry<Integer, Pair<Integer,List<Integer>>>,String> ThreadsCol;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        BarrierAddressCol.setCellValueFactory(p->new SimpleStringProperty(p.getValue().getKey() + " "));
        BarrierNCol.setCellValueFactory(p->new SimpleStringProperty(p.getValue().getValue().getKey() + " "));
    ...
    private void setBarrierTable() {
        barrierTable.setItems(FXCollections.observableList(new ArrayList<>(myController.getRepository().getProgramList().get(0).getBarrierTable().getContent().entrySet())));
