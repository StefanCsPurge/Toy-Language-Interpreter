...
import Model.statement.CyclicBarrier.AwaitStmt;
import Model.statement.CyclicBarrier.NewBarrierStmt;
...
public class Main {
    public static void main(String[] args){
        ...
        console.addCommand(new RunExampleCommand("9","*wait example*",examples.get(8)));
        console.addCommand(new RunExampleCommand("10","*Barrier example*",examples.get(9)));
    ...
    public static List<Statement> getExamples() {
        ...
        Statement ex10 = assemble(
                new VarDeclStmt("v1", new RefType(new IntType())),  new VarDeclStmt("v2", new RefType(new IntType())),  new VarDeclStmt("v3", new RefType(new IntType())), new VarDeclStmt("cnt", new IntType()),
                new NewStmt("v1",new ValueExpression(new IntValue(2))), new NewStmt("v2",new ValueExpression(new IntValue(3))), new NewStmt("v3",new ValueExpression(new IntValue(4))),
                new NewBarrierStmt("cnt", new ReadHeapExpression(new VariableExpression("v2"))),
