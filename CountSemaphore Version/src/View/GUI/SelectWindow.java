...
public class SelectWindow implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        optStr.add("*switch example*");
        optStr.add("*semaphore example*");
        ...
        runOptionButton.setOnAction(actionEvent -> {
            ...
            try {
                programTorRun.typeCheck(new Dictionary<>());
                ProgramState realProgram = new ProgramState(new Stack<>(), new Dictionary<>(), new MyList<>(), new Dictionary<>(), new Heap<>(), new SemaphoreTable(), programTorRun);
