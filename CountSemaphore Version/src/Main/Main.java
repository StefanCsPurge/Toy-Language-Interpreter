...
import Model.statement.Semaphore.AcquireStmt;
import Model.statement.Semaphore.CreateSemaphoreStmt;
import Model.statement.Semaphore.ReleaseStmt;
...
public class Main {
    public static void main(String[] args){
        ...
        console.addCommand(new RunExampleCommand("9","*switch example*",examples.get(8)));
        console.addCommand(new RunExampleCommand("10","*semaphore example*",examples.get(9)));
    ...
    public static List<Statement> getExamples() {
        ...
        */
        ...
        Statement ex9 = new CompStmt(new VarDeclStmt("a", new IntType()),
                        new CompStmt(new VarDeclStmt("b", new IntType()),
                        new CompStmt(new VarDeclStmt("c", new IntType()),
                                new CompStmt(new AssignStmt("a", new ValueExpression(new IntValue(1))),
                                        new CompStmt(new AssignStmt("b", new ValueExpression(new IntValue(2))),
                                                new CompStmt(new AssignStmt("c", new ValueExpression(new IntValue(5))),
                                                        new CompStmt(new SwitchStmt(new ArithmeticExpression('*',new VariableExpression("a"), new ValueExpression(new IntValue(10))),
                                                                new ArithmeticExpression('*',new VariableExpression("b"), new VariableExpression("c")),
                                                                new CompStmt(new PrintStmt(new VariableExpression("a")), new PrintStmt(new VariableExpression("b"))),
                                                                new ValueExpression(new IntValue(10)),
                                                                new CompStmt(new PrintStmt(new ValueExpression(new IntValue(100))), new PrintStmt(new ValueExpression(new IntValue(200)))),
        ...
        */
        ...
        Statement ex10 = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())),
                new CompStmt(new VarDeclStmt("cnt", new IntType()),
                        new CompStmt(new NewStmt("v1", new ValueExpression(new IntValue(1))),
                                new CompStmt(new CreateSemaphoreStmt(new VariableExpression("cnt"),new ReadHeapExpression(new VariableExpression("v1"))),
                                        new CompStmt(new ForkStmt(new CompStmt(new AcquireStmt(new VariableExpression("cnt")),
                                                new CompStmt(new WriteHeapStmt("v1",new ArithmeticExpression('*', new ReadHeapExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(10)))),
                                                        new CompStmt(new PrintStmt(new ReadHeapExpression(new VariableExpression("v1"))), new ReleaseStmt(new VariableExpression("cnt")))))),
                                                new CompStmt(new ForkStmt(new CompStmt(new AcquireStmt(new VariableExpression("cnt")),
                                                        new CompStmt(new WriteHeapStmt("v1",new ArithmeticExpression('*', new ReadHeapExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(10)))),
                                                                new CompStmt(new WriteHeapStmt("v1",new ArithmeticExpression('*', new ReadHeapExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(2)))),
                                                                        new CompStmt(new PrintStmt(new ReadHeapExpression(new VariableExpression("v1"))), new ReleaseStmt(new VariableExpression("cnt"))))))),
                                                        new CompStmt(new AcquireStmt(new VariableExpression("cnt")),
                                                                new CompStmt(new PrintStmt(new ArithmeticExpression('-', new ReadHeapExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(1)))),
                                                                        new ReleaseStmt(new VariableExpression("cnt"))))
                                                ))))));
